...
class CrossEntropyLoss (BaseCriterion):
    ...
    def forward(self, a, b):
        return torch.nn.functional.cross_entropy(a, b, reduction=self.reduction)
...
class Regr3D (Criterion, MultiLoss):
    ...
    def get_all_pts3d(self, gt1, gt2, pred1, pred2, dist_clip=None):
        ...
        # normalize 3d points
        if self.norm_mode:
            pr_pts1, pr_pts2, norm_factor = normalize_pointcloud(pr_pts1, pr_pts2, self.norm_mode, valid1, valid2, ret_factor=True)
